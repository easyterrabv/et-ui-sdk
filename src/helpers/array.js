...
export const makeArray = (value, preserveFalse = true, preserveNull = false) => {
...
export const areArraysWithObjectsEqual = (matchKey, array1, array2) => {
    ...
    return array1.every((array1Item) => {
        ...
        const foundInArray2 = !!array2.find((array2Item) => {
