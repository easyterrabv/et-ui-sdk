...
button.et-sdk-button__default {
    border: 1px solid var(--et-sdk-dark-300);
}

button.et-sdk-button:hover:not(.et-sdk-button__readonly):not(
        .et-sdk-button__disabled
    ),
button.et-sdk-button__active:not(.et-sdk-button__readonly):not(
        .et-sdk-button__disabled
    ) {
    background-color: var(--et-sdk-dark-200);
}

button.et-sdk-button__disabled,
button.et-sdk-button__disabled:hover {
    background-color: var(--et-sdk-dark-100);
    cursor: not-allowed;
}

button.et-sdk-button__primary {
    border: 1px solid var(--et-sdk-blue-600);
    background-color: var(--et-sdk-blue-600);
    color: var(--et-sdk-light-0);
}

button.et-sdk-button__primary:hover:not(.et-sdk-button__readonly):not(
        .et-sdk-button__disabled
    ),
button.et-sdk-button__active.et-sdk-button__primary:not(
        .et-sdk-button__readonly
    ):not(.et-sdk-button__disabled) {
    border: 1px solid var(--et-sdk-blue-700);
    background-color: var(--et-sdk-blue-700);
}

button.et-sdk-button__disabled.et-sdk-button__primary,
button.et-sdk-button__disabled.et-sdk-button__primary:hover {
    border: 1px solid var(--et-sdk-blue-400);
    background-color: var(--et-sdk-blue-400);
}

button.et-sdk-button__success {
    border: 1px solid var(--et-sdk-success-500);
    background-color: var(--et-sdk-success-500);
    color: var(--et-sdk-light-0);
}

button.et-sdk-button__success:hover:not(.et-sdk-button__readonly):not(
        .et-sdk-button__disabled
    ),
button.et-sdk-button__active.et-sdk-button__success:not(
        .et-sdk-button__readonly
    ):not(.et-sdk-button__disabled) {
...
button.et-sdk-button__disabled.et-sdk-button__success,
button.et-sdk-button__disabled.et-sdk-button__success:hover {
    border: 1px solid var(--et-sdk-success-300);
    background-color: var(--et-sdk-success-300);
}

button.et-sdk-button__danger {
    border: 1px solid var(--et-sdk-danger-500);
    background-color: var(--et-sdk-danger-500);
    color: var(--et-sdk-light-0);
}

button.et-sdk-button__danger:hover:not(.et-sdk-button__readonly):not(
        .et-sdk-button__disabled
    ),
button.et-sdk-button__active.et-sdk-button__danger:not(
        .et-sdk-button__readonly
    ):not(.et-sdk-button__disabled) {
...
button.et-sdk-button__disabled.et-sdk-button__danger,
button.et-sdk-button__disabled.et-sdk-button__danger:hover {
    border: 1px solid var(--et-sdk-danger-300);
    background-color: var(--et-sdk-danger-300);
}

button.et-sdk-button__warning {
    border: 1px solid var(--et-sdk-warning-500);
    background-color: var(--et-sdk-warning-500);
    color: var(--et-sdk-light-0);
}

button.et-sdk-button__warning:hover:not(.et-sdk-button__readonly):not(
        .et-sdk-button__disabled
    ),
button.et-sdk-button__active.et-sdk-button__warning:not(
        .et-sdk-button__readonly
    ):not(.et-sdk-button__disabled) {
...
button.et-sdk-button__disabled.et-sdk-button__warning,
button.et-sdk-button__disabled.et-sdk-button__warning:hover {
    border: 1px solid var(--et-sdk-warning-300);
    background-color: var(--et-sdk-warning-300);
}

button.et-sdk-button__text {
    border: 1px solid transparent;
    background-color: transparent;
}

button.et-sdk-button__text:hover:not(.et-sdk-button__readonly):not(
        .et-sdk-button__disabled
    ),
button.et-sdk-button__active.et-sdk-button__text:not(
        .et-sdk-button__readonly
    ):not(.et-sdk-button__disabled) {
    border: 1px solid transparent;
...
button.et-sdk-button__disabled.et-sdk-button__text,
button.et-sdk-button__disabled.et-sdk-button__text:hover {
    border: 1px solid transparent;
    background-color: transparent;
    color: var(--et-sdk-dark-500);
}

button.et-sdk-button__readonly {
    cursor: default;
}

button.et-sdk-button__xs {
    padding: 4px 8px;
    font-size: var(--et-sdk-font-size-tiny);
    line-height: 16px;
}

button.et-sdk-button__s {
    padding: 6px 10px;
    font-size: var(--et-sdk-font-size-normal);
    line-height: 20px;
}

button.et-sdk-button__l {
    padding: 10px 14px;
